    ...
    $(document).ready(function () {
        $("#scheduleButton").click(function () {
            ...
            var formData = {
                ...
                tgrade: grade,
                tagency: agency,
                training_reg_start_dt: appStartDate,
                training_reg_end_dt: appEndDate,
                actual_start_dt: trainingStartDate,
                actual_end_dt: trainingEndDate
            };
...
<body>
    <div class="container">
        ...
        <form action="" method="post" id="scheduleButton">
          ...
          <div class="form-group">
                ...
                <input type="text" class="form-control" id="venueId" name="venueId" placeholder="Enter Training ReferenceId..." required>
            </div>
            ...
            <div class="form-group">
                <button type="submit" value="">SCHEDULE</button>
            </div>
        </form>
    </div>
